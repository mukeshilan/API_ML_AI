...
标题 | 用户案例 | 重要程度 | 笔记
-----|----------|----------|-----
辨别动物品种 | 赵同学某天看到一只宠物狗，但是分不清它的品种是金毛还是拉布拉多 | 重要 | 动物识别
科普 | 钱女士带着小钱外出游玩，看到一只昆虫，小钱问钱女士昆虫的名字，钱女士无法回答 | 重要 | 儿童科普
交流 | 用户识别后觉得有误或图片不能够被识别，可以将识别结果分享出去，请其他用户一起分析得出正确结果 |次重要 | 动物识别
...
- 用户可根据识别结果进行更正反馈，APP收集反馈后可进行定制化图像识别提高识别率。
...
- [阿里云动物识别](https://market.aliyun.com/products/57124001/cmapi028672.html?spm=5176.11065268.1996646101.searchclickresult.2cda551buSWWxd#sku=yuncode2267200001)：
    - 优点：1.输出结果包括动物名称或类型；2.识别准确率高达90%以上；
    - 缺点：价格过高
...
## 使用后风险报告
- 若“动物世界APP”不被知识图谱CN-DBpedia支持，则使用百度百科数据（月2018年7月5日开放）.
...
- [EasyDL定制化图像识别](http://ai.baidu.com/easydl/home.html)
